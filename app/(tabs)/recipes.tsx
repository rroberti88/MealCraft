...
export default function RecipesScreen() {
  ...
  const handleSave = () => {
    const isIngValid = form.ingredienti.every(
      (i) =>
        i.nome.trim() !== '' &&
        i.qta.trim() !== ''
    );
    ...
    const recipeData: Recipe = {
      ...
      tempoPreparazione:
        parseInt(form.tempo) || 0,

      difficolta: form.difficolta,

      porzioni:
        parseInt(form.porzioni) || 1,
        ...
        <View>
          ...
          {isPickerMode && (
            <Text style={styles.pickerSubtitle}>
              Seleziona un piatto per {mealType}
            </Text>
          )}
        </View>
          ...
          <View style={styles.card}>
            ...
            {isPickerMode && (
              <TouchableOpacity
                ...
                onPress={() =>
                  handleSelectForPlanner(item)
                }
              >
                <Text style={styles.selectBtnText}>
                  SELEZIONA PER IL PIANO
                </Text>
              </TouchableOpacity>
            )}
